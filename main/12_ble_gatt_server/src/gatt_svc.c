...
static bool heart_rate_notify_status = false;
...
void send_heart_rate_notification(void) {
    if (heart_rate_notify_status && heart_rate_chr_conn_handle_inited) {
        ble_gatts_notify(heart_rate_chr_conn_handle,
                           heart_rate_chr_val_handle);
        ESP_LOGI(TAG, "heart rate notify sent!");
    }
}
...
void gatt_svr_subscribe_cb(struct ble_gap_event *event) {
    ...
    if (event->subscribe.attr_handle == heart_rate_chr_val_handle) {
        ...
        heart_rate_notify_status = event->subscribe.cur_notify;
    }
}
...
void gatt_svr_reset_heart_rate_subscription(void) {
    ...
    heart_rate_notify_status = false;
}
